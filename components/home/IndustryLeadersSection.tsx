...
export default function IndustryLeadersSection() {
  ...
  const partners = [
    ...
    { id: 21, name: "Tamil Nadu Pollution board, TamilNadu  ", tagline: "", icon: "/images/tamil-nadu-pollution-board-tamilnadu.svg", categories: ["Cousultancy"] },
    ...
    { id: 45, name: "Tamil Nadu Pollution board, TamilNadu ", tagline: " ", icon: "/images/tamil-nadu-pollution-board-tamilnadu.svg", categories: ["Research and Development"] },
    ...
    { id: 77, name: "UiPath, Bangalore ", tagline: " ", icon: "/images/logo-31.svg", categories: ["Training"] },
    { id: 78, name: "V M Ware ", tagline: " ", icon: "/images/logo-32.svg", categories: ["Training"] }, { id: 77, name: " ", tagline: " ", icon: "/images/logo-.svg", categories: ["Training"] },
    { id: 78, name: "VARPAS media technologies ", tagline: " ", icon: "/images/logo-33.svg", categories: ["Training"] },
    { id: 79, name: "Fibro Foods", tagline: " ", icon: "/images/logo-34.svg", categories: ["Sona School of Business and Management"] },
    { id: 80, name: "Janalakshmi Financial Services", tagline: " ", icon: "/images/logo-35.svg", categories: ["Sona School of Business and Management"] },
    { id: 81, name: "JSW Steel limited", tagline: " ", icon: "/images/logo-36.svg", categories: ["Sona School of Business and Management"] },
    { id: 82, name: "My Play Factory", tagline: " ", icon: "/images/logo-37.svg", categories: ["Sona School of Business and Management"] },
    { id: 83, name: "Sona STAR", tagline: " ", icon: "/images/logo-38.svg", categories: ["Sona School of Business and Management"] },
    { id: 84, name: "Sri Jayashree Food Products", tagline: " ", icon: "/images/logo-39.svg", categories: ["Sona School of Business and Management"] },
    { id: 85, name: "Triveni Cars Private Ltd", tagline: " ", icon: "/images/logo-40.svg", categories: ["Sona School of Business and Management"] },
    { id: 86, name: "Vee Technologies", tagline: " ", icon: "/images/logo-41.svg", categories: ["Sona School of Business and Management"] },
  ];
