    ...
    <section className="py-16 bg-gray-50">
      ...
      <div className="text-center max-w-2xl mx-auto mb-14 px-4">
        ...
        <p className="text-gray-600 mt-4">
          Choose from our flexible partnership models designed to meet your
          specific business objectives and talent requirements
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto px-6">
        {models.map((item, i) => (
          <div
            key={i}
            className="bg-white rounded-3xl shadow-md hover:shadow-xl transition-all p-8 flex flex-col"
          >
            {/* Icon */}
            <div
              className={`w-14 h-14 ${item.iconBg} rounded-xl flex items-center justify-center mb-5`}
            >
              {item.icon}
            </div>
