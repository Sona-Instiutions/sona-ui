  ...
  const values = [
    {
      ...
      description:
        "We uphold transparency and honesty in all our operations, building lasting relationships with clients and stakeholders worldwide.",
    ...
    },
    {
      ...
      description:
        "Continuous innovation drives our solutions, integrating emerging technologies to empower businesses with competitive advantage.",
    ...
    },
    {
      ...
      description:
        "We believe in cross-functional collaboration, combining global expertise with local insights to deliver exceptional results.",
    ...
    },
    {
      ...
      description:
        "Our initiatives focus on responsible growth, aligning with ESG principles for long-term positive impact on society and business.",
    ...
    },
    {
      ...
      description:
        "We pursue excellence in every service, fostering a culture of high performance and continuous improvement.",
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-3xl mx-auto text-center mb-10">
          ...
          <p className="mt-4 text-gray-600 max-w-2xl mx-auto">
            Integrity, innovation, collaboration, sustainability, and excellence
            form the foundation of our work culture and global partnerships.
          </p>
        </div>
