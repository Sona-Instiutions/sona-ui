  ...
  const values = [
    {
      ...
      description:
        "Curriculum and initiatives shaped by CXOs, founders, and tech practitioners",
    ...
    },
    {
      ...
      description:
        "Real projects, live challenges, corporate mentors embedded in every program",
    ...
    },
    {
      ...
      description:
        "Graduates are immediately productive in enterprise environments",
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-3xl mx-auto text-center mb-10">
          ...
          <p className="mt-4 text-gray-600 max-w-2xl mx-auto">
           By the Industry, For the Industry, To the Industry. All SCALE verticals operate on a principle of industry co-creation. Rather than theoretical learning disconnected from real business needs, SCALE programs are:
          </p>
        </div>
